error id: file:///D:/Revature/P2Team3/enrichscala/src/main/scala/example/enrich/FeatureBuilder.scala:DataFrame#
...
non-local guesses:
	 ...
	 -org/apache/spark/sql/functions/DataFrame#
	 -DataFrame#
...
object FeatureBuilder {
  ...
  def build(df: D@@ataFrame): DataFrame = {
